...
train_generator = loadGeneratorBasic(X_train,y_train,params)
...
test_generator = loadGeneratorBasic(X_test,y_test,params)
...
for epoch in tqdm(range(n_epoch)):
    ...
    for i, (seq, labels) in tqdm(enumerate(train_generator)):
